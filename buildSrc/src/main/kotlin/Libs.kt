...
object Plugins {
    ...
    object Versions {
        ...
        const val dependency_management = "1.1.4"  // https://mvnrepository.com/artifact/io.spring.dependency-management/dependency-management-plugin
...
object Versions {
    ...
    const val reactor_bom = "2023.0.11"     // https://mvnrepository.com/artifact/io.projectreactor/reactor-bom
    ...
    const val netty = "4.1.114.Final"  // https://mvnrepository.com/artifact/io.netty/netty-all

    const val aws = "1.12.772"    // https://mvnrepository.com/artifact/com.amazonaws
    const val aws2 = "2.29.0"   // https://mvnrepository.com/artifact/software.amazon.awssdk/aws-sdk-java
    const val aws2_crt = "0.33.0" // https://mvnrepository.com/artifact/software.amazon.awssdk.crt/aws-crt
    const val aws_kotlin = "1.3.61" // https://mvnrepository.com/artifact/aws.sdk.kotlin
    ...
    const val protobuf = "3.25.3"   // https://mvnrepository.com/artifact/com.google.protobuf/protobuf-java
    ...
    const val redisson = "3.37.0"       // https://mvnrepository.com/artifact/org.redisson/redisson
    ...
    const val blaze_persistence = "3.15.1" // https://mvnrepository.com/artifact/io.quarkus.platform/quarkus-blaze-persistence-bom
    const val javers = "7.6.3"  // https://github.com/javers/javers

    const val slf4j = "2.0.16"      // https://mvnrepository.com/artifact/org.slf4j/slf4j-api
    const val logback = "1.5.11"     // https://mvnrepository.com/artifact/ch.qos.logback/logback-classic
    ...
    const val micrometerContextPropagation =
        "1.1.1" // https://mvnrepository.com/artifact/io.micrometer/context-propagation
    ...
    const val elasticsearch = "8.15.3"   // https://mvnrepository.com/artifact/org.elasticsearch.client/elasticsearch-rest-client

    const val kafka = "3.7.1"           // https://mvnrepository.com/artifact/org.apache.kafka/kafka
    const val spring_kafka = "3.2.1"   // https://mvnrepository.com/artifact/org.springframework.kafka/spring-kafka
...
object Libs {
    ...
    val aws_kotlin_sesv2 = awsKotlin("sesv2-jvm")
    // deprecated
    ...
    const val byte_buddy = "net.bytebuddy:byte-buddy:1.14.13"   // https://mvnrepository.com/artifact/net.bytebuddy/byte-buddy-agent
    ...
    const val mysql_connector_j = "com.mysql:mysql-connector-j:8.3.0"
    const val mariadb_java_client = "org.mariadb.jdbc:mariadb-java-client:3.1.4"
    const val postgresql_driver = "org.postgresql:postgresql:42.7.3"
    const val oracle_ojdbc8 = "com.oracle.ojdbc:ojdbc8:19.3.0.0"
    const val clickhouse_jdbc = "com.clickhouse:clickhouse-jdbc:0.6.0-patch3"
