...
abstract class AbstractCassandraTestConfiguration: AbstractCassandraConfiguration() {
    ...
    companion object {
        ...
        init {
            ...
            Cassandra4Server.Launcher.recreateKeyspace(io.bluetape4k.spring.cassandra.AbstractCassandraTestConfiguration.Companion.DEFAULT_KEYSPACE)
        }
    }
    ...
    override fun getKeyspaceName(): String =
        io.bluetape4k.spring.cassandra.AbstractCassandraTestConfiguration.Companion.DEFAULT_KEYSPACE
