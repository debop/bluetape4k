...
object BinarySerializers {
    ...
    val ZstdJdk: BinarySerializer by lazy { ZstdJdkSerializer() }
    ...
    val ZstdKryo: BinarySerializer by lazy { ZstdKryoSerializer() }
    ...
    val ZstdMarshalling: BinarySerializer by lazy { ZstdMarshallingSerializer() }
}
