...
object Systemx {
    ...
    @JvmStatic
    val FileEncoding: String by lazy { System.getProperty("file.encoding") ?: Charsets.UTF_8.name() }
    ...
    @JvmStatic
    val isWindows: Boolean by lazy { OSName?.contains("win") ?: false }

    @JvmStatic
    val isMac: Boolean by lazy { OSName?.contains("mac") ?: false }

    @JvmStatic
    val isSolaris: Boolean by lazy { OSName?.contains("sunos") ?: false }
