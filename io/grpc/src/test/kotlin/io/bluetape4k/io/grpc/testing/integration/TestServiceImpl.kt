...
import io.bluetape4k.io.grpc.interceptor.echoRequestHeadersInterceptor
import io.bluetape4k.io.grpc.interceptor.echoRequestMetadataInHeaders
import io.bluetape4k.io.grpc.interceptor.echoRequestMetadataInTrailers
...
class TestServiceImpl @JvmOverloads constructor(
    ...
    override fun streamingOutputCall(request: StreamingOutputCallRequest): Flow<StreamingOutputCallResponse> {
        return flow {
            ...
            request.responseParametersList.forEach { params ->
                ...
                val response = StreamingOutputCallResponse
                    .newBuilder()
                    .apply {
     ...
     */
    override fun halfDuplexCall(requests: Flow<StreamingOutputCallRequest>): Flow<StreamingOutputCallResponse> {
        return flow {
