...
class ParseNamedDataSourcePropertiesTest: AbstractJacksonTextTest() {
    ...
    inner class ParseProperties {
        ...
        |bluetape4k.datasources.default.connectionPool=dbcp2
        |bluetape4k.datasources.default.driverClassName=mysql
        |bluetape4k.datasources.default.url=jdbc:mysql://localhost:3306/test
        |bluetape4k.datasources.default.username=sa
        |bluetape4k.datasources.default.password=password
        |bluetape4k.datasources.default.maxTotal=50
        |bluetape4k.datasources.default.maxIdle=40
        |bluetape4k.datasources.default.minIdle=10
        |bluetape4k.datasources.default.maxWaitMillis=
        |bluetape4k.datasources.default.lifo=true
        |bluetape4k.datasources.default.connectionProperties=
        |bluetape4k.datasources.read.connectionPool=hikari
        |bluetape4k.datasources.read.driverClassName=mariadb
        |bluetape4k.datasources.read.url=jdbc:mysql://localhost:3307/test
        |bluetape4k.datasources.read.username=sa
        |bluetape4k.datasources.read.password=password
        |bluetape4k.datasources.read.connectionTimeout=5000
        |bluetape4k.datasources.read.idleTimeout=
        |bluetape4k.datasources.read.maxLifetime=60000
        |bluetape4k.datasources.read.properties.1=cachePropStmts=true
        |bluetape4k.datasources.read.properties.2=prepStmtCacheSize=250
        |bluetape4k.datasources.read.properties.3=propStmtCacheSqlLimit=2048
        |
        """.trimMargin()
