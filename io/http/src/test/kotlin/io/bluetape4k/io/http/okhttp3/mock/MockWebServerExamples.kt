package io.bluetape4k.io.http.okhttp3.mock

import com.fasterxml.jackson.module.kotlin.readValue
import io.bluetape4k.io.http.okhttp3.bodyAsString
import io.bluetape4k.io.http.okhttp3.execute
import io.bluetape4k.io.http.okhttp3.okhttp3Client
import io.bluetape4k.io.http.okhttp3.okhttp3Request
...
class MockWebServerExamples {
    ...
    fun `MockServer 에서 Request 정보 조회하기`() {
        ...
        val request = okhttp3Request {
            url(mockServer.baseUrl + "repository?name=bluetape4k")
            get()
        }
        assertHttpResponse(request)
        ...
        recordedRequest.requestUrl.toString() shouldBeEqualTo mockServer.baseUrl + "repository?name=bluetape4k"
        recordedRequest.path shouldBeEqualTo "/repository?name=bluetape4k"
    }
