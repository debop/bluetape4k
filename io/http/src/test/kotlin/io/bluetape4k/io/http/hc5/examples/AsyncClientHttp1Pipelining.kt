...
import io.bluetape4k.io.http.hc5.config.tlsConfig
import io.bluetape4k.io.http.hc5.nio.executeSuspending
...
class AsyncClientHttp1Pipelining: AbstractHc5Test() {
    ...
    fun `pipelined execution of multiple HTTP 1_1 message exchanges`() = runTest {
        ...
        val endpoint = client.lease(target, null).awaitSuspending()
