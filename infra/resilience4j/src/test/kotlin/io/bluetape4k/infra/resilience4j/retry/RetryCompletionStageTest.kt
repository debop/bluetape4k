...
import io.bluetape4k.infra.resilience4j.HelloWorldException
...
class RetryCompletionStageTest {
    ...
    private val helloWorldService: io.bluetape4k.infra.resilience4j.AsyncHelloWorldService = mockk(relaxUnitFun = true)
