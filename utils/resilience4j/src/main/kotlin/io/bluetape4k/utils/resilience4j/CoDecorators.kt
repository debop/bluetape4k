...
object CoDecorators {
     ...
     */
    fun ofRunnable(runnable: suspend () -> Unit): CoDecoratorForFunction<Unit> =
        CoDecoratorForFunction(runnable)
     ...
     */
    fun <T: Any> ofSupplier(supplier: suspend () -> T): CoDecoratorForFunction<T> =
        CoDecoratorForFunction(supplier)
     ...
     */
    fun <T: Any> ofConsumer(consumer: suspend (T) -> Unit): (T) -> CoDecoratorForFunction<Unit> = { input: T ->
        ofRunnable { consumer(input) }
    }

    fun <T: Any, R: Any> ofFunction(function: suspend (T) -> R): (T) -> CoDecoratorForFunction<R> = { input: T ->
...
//        }
//
//        fun withCoroutinesCache(coroutinesCache: CoroutinesCache<T, R>) = apply {
//            func = coroutinesCache.decorateSuspendedFunction(func)
//        }
//
...
//
//        fun withCircuitBreaker(circuitBreaker: CircuitBreaker) = apply {
//            func = circuitBreaker.decorateSuspendFunction2(func)
//        }
//
//        fun withRetry(retry: Retry) = apply {
//            func = retry.decorateSuspendFunction2(func)
//        }
//
//        fun withRateLimit(rateLimiter: RateLimiter) = apply {
//            func = rateLimiter.decorateSuspendFunction2(func)
//        }
//
//        fun withBulkhead(bulkhead: Bulkhead) = apply {
//            func = bulkhead.decorateSuspendFunction2(func)
//        }
//
//        fun withTimeLimiter(timeLimiter: TimeLimiter) = apply {
//            func = timeLimiter.decorateSuspendFunction2(func)
//        }
//
