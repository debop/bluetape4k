...
internal fun makeId(timestamp: Long, machineId: Int, sequence: Int): Long {
    // log.trace { "Make Id. timestamp=$timestamp, machineId=$machineId, sequence=$sequence" }
...
internal fun parseSnowflakeId(id: Long): SnowflakeId {
    ...
    // log.trace { "Parse Id[$id], timestamp=$timestamp, machineId=$machineId, sequence=$sequence" }
