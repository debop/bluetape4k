...
class P50kBaseTest {
    ...
    companion object: KLogging() {
        private val ENCODING = Encodings.newDefaultEncodingRegistry().getEncoding(EncodingType.P50K_BASE)
        private const val CSV_FILE = "/encidings/p50k_base_encodings.csv"
    ...
    fun `encodes stable`(input: String) {
        ...
        log.trace { "actual=$actual, input=$input" }
