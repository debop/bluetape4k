...
fun main(vararg args: String) {
    runApplication<io.bluetape4k.workshop.redis.examples.RedisApplication>(*args)
}
...
class RedisApplication {
    ...
    @Bean
    fun repoMetricsPostProcessor(): io.bluetape4k.workshop.redis.examples.RedisApplication.RepoMetricsPostProcessor {
        return io.bluetape4k.workshop.redis.examples.RedisApplication.RepoMetricsPostProcessor()
    }
