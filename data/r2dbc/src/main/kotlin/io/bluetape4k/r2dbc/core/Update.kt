...
fun io.bluetape4k.r2dbc.R2dbcClient.update(): UpdateTableSpec {
...
internal class UpdateTableSpecImpl(private val client: io.bluetape4k.r2dbc.R2dbcClient): UpdateTableSpec {
